...
const EXEGESIS_DATA = {
    ...
    "义": {
        "shuowen": "义，己之威仪也。从我羊。",
        "duanzhu": "义，宜也。裁制事物使各宜也。",
        "benyi": "合宜，恰当",
        "yinshenyi": ["正义", "意义", "义理"],
        "qinmu": "《论语》：君子喻于义",
        "warning": "孟子'舍生取义'之'义'指道德准则"
    },
    "礼": {
        "shuowen": "礼，履也。所以事神致福也。",
        "duanzhu": "礼者，理也。",
        "benyi": "社会规范、道德准则",
        "yinshenyi": ["礼仪", "礼物", "礼节"],
        "qinmu": "《论语》：不学礼，无以立",
        "warning": "礼包含外在仪式与内在德行"
    },
    "智": {
        "shuowen": "智，识词也。从白从亏从知。",
        "duanzhu": "智，明也。知也。",
        "benyi": "智慧，知识",
        "yinshenyi": ["聪明", "智谋", "明智"],
        "qinmu": "《论语》：知者不惑",
        "warning": "儒家'智'指辨别是非善恶的能力"
    },
    "信": {
        "shuowen": "信，诚也。从人从言。",
        "duanzhu": "信，诚也。",
    ...
    "中庸": {
        "shuowen": "中，和也。",
        "duanzhu": "中者，无过不及之名。庸者，平常也。",
        "benyi": "不偏不倚，恰到好处",
        "yinshenyi": ["中正", "平淡"],
        "qinmu": "《论语》：中庸之为德也，其至矣乎",
        "warning": "朱熹：中庸是孔门最高德行"
    },
    "格物": {
        "shuowen": "格，榜也。",
        "duanzhu": "格，至也。物，犹事也。",
    ...
    "修身": {
        "shuowen": "修，饰也。从彡。",
        "duanzhu": "修者，治也。治之以为工也。",
        "benyi": "修养身心",
        "yinshenyi": ["修改", "修理"],
        "qinmu": "《大学》：自天子以至于庶人，壹是皆以修身为本",
        "warning": "修身是'八条目'的核心"
    },
    "齐家": {
        "shuowen": "齐，禾麦吐穗上平也。",
    ...
    "明德": {
        ...
        "duanzhu": "明德者，人之所得乎天，而虚灵不昧，以具众理而应万事者也。",
        "benyi": "光明的德行",
        "yinshenyi": ["光明", "明白"],
        "qinmu": "《大学》：在明明德",
        "warning": "朱熹：明德是'天理'在人心中的体现"
    },
    "亲民": {
        "shuowen": "亲，至也。从见亲声。",
        "duanzhu": "亲者，爱也。民者，众人也。",
        "benyi": "亲爱民众/革新民众",
        "yinshenyi": ["亲人", "亲自"],
        "qinmu": "《大学》：在亲民",
        "warning": "朱熹改'亲民'为'新民'"
    ...
    "八卦": {
        "shuowen": "八，别也。像分别相背之形。",
        "duanzhu": "八卦者，伏羲画之以象万物之情也。",
        "benyi": "乾、坤、震、巽、坎、离、艮、兑八种符号",
        "yinshenyi": ["八角", "八个"],
        "qinmu": "《周易》：四象生八卦",
        "warning": "八卦象征天地雷风水火山泽八种自然现象"
    },
    "五行": {
        "shuowen": "五，五行也。从二，阴阳在天地间交午也。",
        "duanzhu": "五行者，水火木金土是也。",
        "benyi": "水、火、木、金、土五种基本物质",
        "yinshenyi": ["五年", "五行山"],
        "qinmu": "《尚书》：五行：一曰水，二曰火，三曰木，四曰金，五曰土",
        "warning": "五行相生相克"
    },
    "天命": {
        "shuowen": "命，使也。从口从令。",
        "duanzhu": "天以阴阳五行化生万物，气以成形，而理亦赋焉。",
        "benyi": "上天的命令/天赋",
        "yinshenyi": ["生命", "命令"],
        "qinmu": "《中庸》：天命之谓性",
        "warning": "天命决定了人的本性"
